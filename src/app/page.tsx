...
import { CarouselProjects } from "@/components/caroussel-projects";
...
export default function Page() {
  ...
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      <section id="hero" className="max-w-3xl mx-auto">
      ...
      <section id="projects">
        <div className="space-y-12 w-full py-12 md-5">
      ...
      <section id="contact" className="max-w-3xl mx-auto my-0 px-6">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Want to chat? Just shoot me an email here{" "}
